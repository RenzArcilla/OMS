...
class MachineProgressBarManager {
    constructor(options = {}) {
        ...
        this.controllerUrl = options.controllerUrl ?? '/OMS/app/controllers/get_machine_output_progress.php'; // Step 3: PHP controller
        this.progressData = [];
        this.init();
    }
...
window.machineProgressBarManager = new MachineProgressBarManager({
    scanDelay: 50,
    controllerUrl: '/OMS/app/controllers/get_machine_output_progress.php'
});
