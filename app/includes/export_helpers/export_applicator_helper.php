...
*/
function exportApplicatorToExcel($include_headers) {

    $records = getApplicatorsForExport();
    ...
    header('Content-Disposition: attachment;filename="applicator_data_export.xlsx"');
