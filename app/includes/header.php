...
<nav class="navbar">
    <div class="nav-container">
        ...
        <a href="/OMS/app/views/home.php">
            <div class="logo">OMS</div>
        </a>
        <div class="nav-right-buttons">
            <a href="/OMS/app/views/account_settings.php" title="Account Settings"  class="account-settings-btn">
...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . '/OMS/app/views/logout.php'; ?>
