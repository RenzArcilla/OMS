            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="displayName" class="form-control" value="" placeholder="Enter your display name">
                        <div class="form-text">This name will be visible as you login to the system</div>
                    </div>
