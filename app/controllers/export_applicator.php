<?php
/*
    This script serves as the controller that handles the export logic for applicator data to excel.
...
require_once __DIR__ . '/../includes/export_helpers/export_applicator_helper.php';
...
exportApplicatorToExcel($include_headers);
exit;